          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  <div className="w-14 h-14 bg-white rounded-full shadow-md flex items-center justify-center shrink-0 border border-gray-100 mr-6">
                    <svg className="w-6 h-6 text-brand-dark" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987H7.898V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                    </svg>
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-900 uppercase tracking-wide mb-1">Facebook</h4>
                    <a
                      href="https://www.facebook.com/profile.php?id=61578109254917"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-xl text-gray-600 hover:text-accent-green transition-colors"
                    >
