          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="md:w-1/2">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-sm font-bold text-accent-green uppercase tracking-widest">Homeowner Solutions</span>
              </div>
              <h2 className="text-3xl font-heading font-bold text-gray-800 mb-4 tracking-tight">
                We Also Serve Residential Clients
              </h2>
              <p className="text-gray-600 leading-relaxed mb-6">
                While our primary expertise is commercial roofing, we bring the same proven restoration technology to homes in the Springfield, MO area. From metal roof restoration to SPF and leak repair — we can extend the life of your residential roof for a fraction of the cost of replacement.
              </p>
              <Link
                to="/services/residential"
                className="inline-flex items-center text-brand-dark font-bold hover:text-accent-green transition-colors uppercase tracking-wide group"
              >
            ...
            <div className="md:w-1/2 grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { label: 'Metal Roof Restoration', icon: ShieldCheck },
                { label: 'Spray Polyurethane Foam', icon: CheckCircle2 },
                { label: 'Roof Coating & Leak Repair', icon: CheckCircle2 },
              ].map(({ label, icon: Icon }) => (
                <Link
                  key={label}
                  to="/services/residential"
                  className="flex flex-col items-center text-center bg-white border border-gray-200 rounded-xl p-5 hover:border-accent-green/50 hover:shadow-md transition-all group"
                >
                  <Icon className="w-7 h-7 text-accent-green mb-3" />
                  <span className="text-sm font-semibold text-gray-700 group-hover:text-accent-green transition-colors">{label}</span>
                </Link>
              ))}
            </div>
          </div>
